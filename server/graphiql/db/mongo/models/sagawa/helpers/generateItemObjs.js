export default function GenerateItemObjs(cart) {
  return cart.map(productDoc => ({
    ...
    itemname: `${productDoc.product.vendor.toUpperCase()} - ${productDoc.product.title.toUpperCase()} NICOTINE ${Number(productDoc.product.nicotineStrength)}mg E-JUICE 30 mil`,
    origin: 'US',
