  ...
  translations: {
    en: {
      messages: {
        ...
        'product.modal.bulk.subtitle3': '25% OFF',
        'product.modal.bulk.subtitle4': 'the price.',
        ...
        'product.modal.bullk.row.shipping': 'Free International Shipping',
        'product.modal.bullk.row.total': 'Grand Total',
        'product.modal.bullk.btns.close': 'Close',
        'product.modal.bullk.btns.oh': 'Oh!',
        'product.modal.bullk.btns.mention': 'Did we mention you get',
