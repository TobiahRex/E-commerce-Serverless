    ...
    <div className="single-product-main">
      <div className="single-product-breadcrumb-container">
        <ul className="single-product-breadcrumb-list">
          <li className="single-product-breadcrumb-path">Home</li>
          <li className="single-product-breadcrumb-path">Fruity Bamm-Bamm</li>
        </ul>
      </div>
      <div className="single-product-breadcrumb-title">
        <h3>Juice</h3>
      </div>
