  ...
  !(function() {
    ...
    window.tram = (function(t) {
      ...
      var S = (e.frame = (function() {
        ...
        H = f(X, function(t, e) {
          (t.init = function(t) {
            (this.context = t.context), (this.update = t.update), (this.tweens = [
          ...
          return (g.init = function(t) {
            ...
            ? function(e, n) {
                ...
                if (!t.isEmptyObject(n)) {
                  ...
                  r === T && (r = i.upstream = null), (i.upstream = T), i.set(
                    v(n),
                  ), (i.upstream = r);
                }
              }
          ...
          return {
            ready: function() {
              ...
              a.on('click', 'a', function(r) {
                if (
                  !(e.env('design') || (window.$.mobile && t(r.currentTarget).hasClass('ui-link')))
                )
        ...
        (t.exports = function(t, i) {
          ...
          function b(e) {
            ...
            s < 0 && (s = 0), (e.anchors = [{ els: [], x: 0, width: 0 }]), e.slides.each(function(
              ...
              r - i > s &&
                (n++, (i += a), (e.anchors[n - 1] = { els: [], x: r, width: 0 })), (o = t(
                c,
