...
import bindRouterActions from '../../services/utils/bindRouterActions';
...
class HomePage extends Component {
  ...
  render() {
    const { mobile, preLoginUrl } = this.props;
...
const mapDispatchToProps = dispatch => bindRouterActions(dispatch);
