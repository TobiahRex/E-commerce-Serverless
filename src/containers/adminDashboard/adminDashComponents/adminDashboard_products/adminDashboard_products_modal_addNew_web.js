            ...
            <tbody className="table__body ">
              <tr className="body__row">
                ...
                <td className="row--thumb1">
                  <img src="https://s3-ap-northeast-1.amazonaws.com/nj2jp-images/nj2jp_juice_card_klp.png" alt="Juice Card" />
                </td>
                <td className="row--thumb2">
                  <img src="https://s3-ap-northeast-1.amazonaws.com/nj2jp-images/nj2jp_juice_card_pc.png" alt="Juice Card" />
                </td>
                <td className="row--thumb3">
                  <img src="https://s3-ap-northeast-1.amazonaws.com/nj2jp-images/nj2jp_juice_card_fbb.png" alt="Juice Card" />
                </td>
