                          ...
                          <tbody className="table__body">
                            <tr className="body__row">
                              <td className="row__image">
                                <img className="image--primary" src="/images/nj2jp-react/nj2jp_juice_card_fvm.png" alt="Juice" />
                                <img className="image--secondary" src="/images/nj2jp-react/nj2jp_juice_card_fvm.png" alt="Juice" />
                                <img className="image--secondary" src="/images/nj2jp-react/nj2jp_juice_card_fvm.png" alt="Juice" />
                              </td>
