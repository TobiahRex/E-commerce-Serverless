      ...
      <div className="main__body">
        <p>
          ...
          * Respond to your questions or comments.
          ...
          <br />
          <br />
          <h4>WHAT CHOICES DO YOU HAVE ABOUT YOUR INFORMATION?</h4>
          <br />
          Our goal is to give you simple and meaningful choices over your information. If you have an Nic Juice To Japan (NJ2JP) account, many of the choices you have on our website are built directly into the product or your account settings. For example, you can:
          {/*
