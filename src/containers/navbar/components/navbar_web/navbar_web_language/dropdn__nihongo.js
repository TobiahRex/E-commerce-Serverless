...
function NavbarOptionsLanguageDropdnNihongo({ onLanguageChange }) {
  ...
  return (
    ...
    >
      <img src="https://s3-ap-northeast-1.amazonaws.com/nj2jp-react/nihongo-flag-border.png" alt="Japanese Flag" className="language-dropdown-content-japanese-image" />
